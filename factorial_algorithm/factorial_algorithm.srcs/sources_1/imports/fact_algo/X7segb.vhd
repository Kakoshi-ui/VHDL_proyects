...
architecture Behavioral of X7segb is
    --se?ales intermedias para conexi?n interna
...
begin
    ...
    aen(3) <= (x(15) or x(14) or x(13) or x(12)); --Activa 3er d?gito
    --si hay datos a la entrada
    aen(2) <= (x(15) or x(14) or x(13) or x(12) or --Activa 3er d?gito
                x(11) or x(10) or x(9) or x(8));--si hay datos a la entrada
    --o si hay datos para d?gito 4
    aen(1) <= (x(15) or x(14) or x(13) or x(12) or --Activa 2o d?gito
               x(11) or x(10) or x(9) or x(8)) or --si hay datos a la entrada
              x(7) or x(6) or x(5) or x(4); --o si hay datos para d?gito 3 ? 4
    aen(0) <= '1'; --Primer d?gito (de derecha a izquierda) siempre encendido
    --contador de 2 bits
    ...
    --Multiplexor de 4x1
    --Selecciona (con la se?al count) 1 de 4 entradas (de 4 bits cada una) 
    with count select
 digit <= x(3 downto 0) when "00",
    ...
    --seg7dec
    --Convierte un n?mero binario de 4 bits a 7 segmentos
    with digit select
