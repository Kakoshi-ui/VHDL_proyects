...
HD_PWD='C:/Digital_Sys_Design/factorial_algorithm/factorial_algorithm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log factorial_algorithm_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source factorial_algorithm_top.tcl -notrace
