...
HD_PWD='C:/Digital_Sys_Design/factorial_algorithm/factorial_algorithm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log factorial_algorithm_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source factorial_algorithm_top.tcl
