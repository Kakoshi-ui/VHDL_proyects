...
HD_PWD='C:/Digital_Sys_Design/arithmetic_unit/arithmetic_unit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arithmetic_unit_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arithmetic_unit_top.tcl -notrace
