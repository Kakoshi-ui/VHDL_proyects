...
HD_PWD='C:/Digital_Sys_Design/arithmetic_unit/arithmetic_unit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arithmetic_unit_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arithmetic_unit_top.tcl
