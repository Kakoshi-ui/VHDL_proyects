...
HD_PWD='C:/Digital_Sys_Design/pass_control/pass_control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pass_control_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pass_control_top.tcl
