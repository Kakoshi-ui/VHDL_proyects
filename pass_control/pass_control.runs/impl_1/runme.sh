...
HD_PWD='C:/Digital_Sys_Design/pass_control/pass_control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pass_control_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pass_control_top.tcl -notrace
