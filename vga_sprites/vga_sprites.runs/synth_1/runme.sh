...
HD_PWD='C:/Digital_Sys_Design/vga_sprites/vga_sprites.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_sprites_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_sprites_top.tcl
