...
HD_PWD='C:/Digital_Sys_Design/vga_sprites/vga_sprites.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_sprites_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_sprites_top.tcl -notrace
