...
HD_PWD='C:/Digital_Sys_Design/GCD_system/GCD_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GCD_system_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GCD_system_top.tcl -notrace
