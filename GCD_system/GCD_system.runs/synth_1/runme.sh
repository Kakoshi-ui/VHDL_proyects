...
HD_PWD='C:/Digital_Sys_Design/GCD_system/GCD_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GCD_system_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GCD_system_top.tcl
