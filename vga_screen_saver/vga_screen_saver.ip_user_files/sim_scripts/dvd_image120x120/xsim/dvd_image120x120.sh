...
#
# Script generated by Vivado on Wed Dec 20 13:46:24 -0600 2023
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dvd_image120x120.sh
...
#
# Usage        : dvd_image120x120.sh
#                dvd_image120x120.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dvd_image120x120.sh [-reset_run]
#                dvd_image120x120.sh [-reset_log]
#                dvd_image120x120.sh [-help]
#
...
# script info
echo -e "dvd_image120x120.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dvd_image120x120.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot dvd_image120x120 xil_defaultlib.dvd_image120x120 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dvd_image120x120 -key {Behavioral:sim_1:Functional:dvd_image120x120} -tclbatch cmd.tcl -protoinst "protoinst_files/dvd_image120x120.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dvd_image120x120.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dvd_image120x120.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dvd_image120x120.sh [-help]\n\
Usage: dvd_image120x120.sh [-step]\n\
Usage: dvd_image120x120.sh [-lib_map_path]\n\
Usage: dvd_image120x120.sh [-reset_run]\n\
Usage: dvd_image120x120.sh [-reset_log]\n\
Usage: dvd_image120x120.sh [-keep_index]\n\
Usage: dvd_image120x120.sh [-noclean_files]\n\n\
