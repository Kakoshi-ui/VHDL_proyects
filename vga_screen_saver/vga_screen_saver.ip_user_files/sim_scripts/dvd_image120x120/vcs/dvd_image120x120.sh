...
#                script (type 'dvd_image120x120.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dvd_image120x120 -o dvd_image120x120_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dvd_image120x120_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dvd_image120x120_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dvd_image120x120_simv.daidir vcs_lib c.obj)
